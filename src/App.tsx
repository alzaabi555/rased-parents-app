...
function App() {
  ...
  if (showWelcomeScreen && allSubjects.length > 0) {
    return (
      <div className="h-screen flex flex-col items-center justify-center p-6 font-sans text-center relative overflow-hidden animate-in fade-in duration-500 bg-gradient-to-br from-[#0f172a] to-[#1e1b4b]" dir="rtl">
  ...
  if (allSubjects.length > 0 && !selectedSubject) {
    return (
      <div className="h-screen flex flex-col font-sans overflow-hidden relative bg-[#0f172a]" dir="rtl">
        {isRamadan && <RamadanTheme />}
